    ...
    <>
      <Box style={{ display: 'flex' }}>
        <Box style={{ flex: 2, padding: '50px', backgroundColor: '#FFE0C2' }}>
          <Text as="div" style={{ textAlign: 'center', justifyContent: 'center', marginLeft: '375px', marginTop: '-250px', backgroundColor: 'white', border: '2px solid #664282', color: '#450c49', width: '600px', height: '150px', borderRadius: '7%', display: 'flex', alignItems: 'center' }}>
