// src/files/projectsData.js
import codeuniverse from '../images/codeuniverse.png';
import surveyFormImage from '../images/Survey-Form.png';
import tributePageImage from '../images/Tribute-Page.png';
import technicalDocumentationPageImage from '../images/Technical-Documentation-Page.png';
import productLandingPageImage from '../images/Product-Landing-Page.png';
import personalPortfolioImage from '../images/Personal-Portfolio.png';
...
import telephoneNumberValidatorImage from '../images/Telephone-Number-Validator.png'
import cashRegisterImage from '../images/Cash-Register.png';
import keyboardKeyImage from '../images/Keyboard-Key.png';
import numberGeneratorGridImage from '../images/Number-Generator-Grid.png';
import infoProjectImage from '../images/Info-Project.png';
import animationImage from '../images/Animation.png';
import solarSystemImage from '../images/Solar-System.png';
import dogAndCatImage from '../images/Dog-and-Cat.png';
import simpleFormImage from '../images/Simple-Form.png';
import hexadecimalColorGeneratorImage from '../images/Hexadecimal-Color-Generator.png';
import partOfTheDayImage from '../images/Part-of-the-Day.png';
import countryToTravelImage from '../images/Country-to-Travel.png';
import randomQuoteMachineImage from '../images/Random-Quote-Machine.png';
import reactMarkdownPreviewerImage from '../images/React-Markdown-Previewer.png';
import drumMachineImage from '../images/Country-to-Travel.png';
import javascriptCalculatorImage from '../images/Javascript-Calculator.png';
import clock25More5Image from '../images/Clock-25-more-5.png';
import barChartImage from '../images/Bar-Chart.png';
import scatterPlotImage from '../images/Scatter-Plot.png';
import heatMapImage from '../images/Heat-Map.png';
import choroplethMapImage from '../images/Choropleth-Map.png';
import treeMapImage from '../images/Tree-Map.png';
import celestialBodiesDatabaseImage from '../images/Celestial-Bodies-Database.png';
import worldcupDatabaseImage from '../images/Worldcup-Database.png';
import salonAppointmentSchedulerImage from '../images/Salon-Appointment-Scheduler.png';
import periodicTableDatabaseImage from '../images/Periodic-Table-Database.png';
import numberGuessDatabaseImage from '../images/Number-Guess-Database.png';
import timestampMicroserviceImage from '../images/Timestamp-Microservice.png';
import requestHeaderParserMicroserviceImage from '../images/Request-Header-Parser-Microservice.png';
import URLShortenerMicroserviceImage from '../images/URL-Shortener-Microservice.png';
import exerciseTrackerImage from '../images/Exercise-Tracker.png';
import fileMetadataMicroserviceImage from '../images/File-Metadata-Microservice.png';
...
import personalLibraryImage from '../images/Personal-Library.png';
import sudokuSolverImage from '../images/Sudoku-Solver.png';
import americanBritishTranslatorImage from '../images/American-British-Translator.png';
import arithmeticFormatterImage from '../images/Arithmetic-Formatter.png';
import timeCalculatorImage from '../images/Time-Calculator.png';
import budgetAppImage from '../images/Budget-App.png';
import polygonAreaCalculatorImage from '../images/Polygon-Area-Calculator.png';
import probabilityCalculatorImage from '../images/Probability-Calculator.png';
import meanVarianceStandardDeviationCalculatorImage from '../images/Mean-Variance-Standard-Deviation-Calculator.png';
import demographicDataAnalyzerImage from '../images/Demographic-Data-Analyzer.png';
import medicalDataVisualizerImage from '../images/Medical-Data-Visualizer.png';
import pageViewTimeSeriesVisualizerImage from '../images/Page-View-Time-Series-Visualizer.png';
import seaLevelPredictorImage from '../images/Sea-Level-Predictor.png';
import stockPriceCheckerImage from '../images/Stock-Price-Checker.png';
import anonymousMessageBoardImage from '../images/Anonymous-Message-Board.png';
import portScannerImage from '../images/Port-Scanner.png';
import sha1PasswordCrackerImage from '../images/SHA-1-Password-Cracker.png';
import secureRealTimeMultiplayerGameImage from '../images/Secure-Real-Time-Multiplayer-Game.png';
import rockPaperScissorsImage from '../images/Rock-Paper-Scissors.png';
import catAndDogImageClassifierImage from '../images/Cat-and-Dog-Image-Classifier.png';
import bookRecommendationEngineUsingKNNImage from '../images/Book-Recommendation-Engine-using-KNN.png';
import linearRegressionHealthCostsCalculatorImage from '../images/Linear-Regression-Health-Costs-Calculator.png';
import neuralNetworkSMSTextClassifierImage from '../images/Neural-Network-SMS-Text-Classifier.png';
import GraphingCalculatorImage from '../images/Graphing-Calculator.png';
import multiFunctionCalculatorImage from '../images/Multi-Function-Calculator.png';
import threeMathGamesImage from '../images/Three-Math-Games.png';
import financialCalculatorImage from '../images/Financial-Calculator.png';
import dataGraphExplorerImage from '../images/Data-Graph-Explorer.png';
import showTheLocalWeatherImage from '../images/Show-the-Local-Weather.png';
import buildAWikipediaViewerImage from '../images/Build-a-Wikipedia-Viewer.png';
import useTheTwitchTVJSONAPIImage from '../images/Use-the-Twitch-TV-JSON-API.png';
import buildAnImageSearchAbstractionLayerImage from '../images/Build-an-Image-Search-Abstraction-Layer.png';
import buildATicTacToeGameImage from '../images/Build-a-Tic-Tac-Toe-Game.png';
import buildASimonGameImage from '../images/Build-a-Simon-Game.png';
import buildAFreeCodeCampForumHomepageImage from '../images/Build-a-freeCodeCamp-Forum-Homepage.png';
import buildARecipeBoxImage from '../images/Build-a-Recipe-Box.png';
import buildTheGameOfLifeImage from '../images/Build-the-Game-of-Life.png';
import buildARoguelikeDungeonCrawlerGameImage from '../images/Build-a-Roguelike-Dungeon-Crawler-Game.png';
import p2pVideoChatApplicationImage from '../images/P2P-Video-Chat-App.png';
import showNationalContiguityWithAForceDirectedGraphImage from '../images/Show-National-Contiguity-with-a-Force-Directed-Graph.png';
import mapDataAcrossTheGlobeImage from '../images/Map-Data-across-the-Globe.png';
import manageABookTradingClubImage from '../images/Manage-a-Book-Trading-Club.png';
import buildAPinterestCloneImage from '../images/Build-a-Pinterest-Clone.png';
import buildANightlifeCoordinationAppImage from '../images/Nightlife-Coordination-App.png';
import chartTheStockMarketImage from '../images/Chart-the-Stock-Market.png';
import buildAVotingAppImage from '../images/Build-a-Voting-App.png';
import buildAPongGameImage from '../images/Build-a-Pong-Game.png';
import buildALightBrightAppImage from '../images/Build-a-Light-Bright-App.png';
...
{
  id: 19,
  name: 'hexadecimal Color Generator',
...
{
  id: 61,
  name: 'Secure Real Time Multiplayer Game',
...
{
  id: 64,
  name: 'Book Recommendation Engine using KNN',
...
{
  id: 66,
  name: 'Neural Network SMS Text Classifier',
...
},
{
  ...
  {
    id: 78,
    name: 'Build a freeCodeCamp Forum Homepage',
